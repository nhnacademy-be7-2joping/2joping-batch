...
/**
 * BookCategoryId 클래스
 * BookCategory 엔티티에서 사용되는 복합 키를 정의하는 클래스입니다.
 * 책(Book)과 카테고리(Category)의 ID를 복합 키로 묶어 고유성을 보장하며, @Embeddable을 통해
...
public class BookCategoryId implements Serializable {
    ...
    /**
     * equals 메서드
     * BookCategoryId 객체 간의 동일성을 비교합니다.
     * bookId와 categoryId가 동일하면 두 객체는 같은 객체로 간주됩니다.
     *
     * @param o 비교할 객체
    ...
    /**
     * hashCode 메서드
     * BookCategoryId 객체의 해시 코드를 생성합니다. 해시 코드는 bookId와 categoryId에 기반하여 생성됩니다.
     *
     * @return 해시 코드 값
     * @author Luha
     * @since 1.0
